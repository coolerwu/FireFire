            ...
            <SettingSection title="数据库维护">
                ...
                >
                    <div className="flex items-center gap-2">
                        {dbStatus === 'ok' && (
                            <span className="text-xs text-notion-accent-green">正常</span>
                        )}
                        {dbStatus === 'error' && (
                            <span className="text-xs text-red-500">有问题</span>
                        )}
                        <button
